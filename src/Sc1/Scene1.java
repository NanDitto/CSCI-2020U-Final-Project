...
public class Scene1 extends Application {
	...
	public String currentFilename = "/home/hanan/Desktop/Sc1/progress.csv"; // intial file name
	...
	public void start(Stage primaryStage) {
		Media media = new Media("file:/home/hanan/Desktop/Sc1/music.mp3");
       	...
       	player.play();
		ImageView home = new ImageView("file:/home/hanan/Desktop/Sc1/q.gif"); // main background image
		...
		scene.getStylesheets().add("file:/home/hanan/Desktop/Sc1/main.css");  // adding styles using css
				...
				if (res == JOptionPane.OK_OPTION) { // do the following when ok is pressed
		            ...
		            while(sc.hasNextLine()){ // read the file until its not the end
						...
						if(details[0].equals(temp1) && details[1].equals(temp2)){ // if the username and password are same, then continue
						    ImageView image = new ImageView("file:/home/hanan/Desktop/Sc1/cm.gif");
					...
					if(opt == false){
					    ImageView image = new ImageView("file:/home/hanan/Desktop/Sc1/x.gif"); // if information is incorrect, then try again
					    pane.getChildren().add(image);
