...
public class Blackjack extends Application {
	...
	public void start(Stage primaryStage) {
		...
		hit.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent e) {
				...
				if (points > 21) { // if the points are greater than 21 on
									// computer side, switch to computer won
					hit.setDisable(true);
	...
	public void score(int number) { // scoring for each picture according to
									// their names for the user

		if (nameOfcard.get(number).equals("3a") || nameOfcard.get(number).equals("3b")
				|| nameOfcard.get(number).equals("3c") || nameOfcard.get(number).equals("3d")) {
			points = points + 3;
			String value = Integer.toString(points);
			userPoints.setText(value);
		}
		if (nameOfcard.get(number).equals("4a") || nameOfcard.get(number).equals("4b")
				|| nameOfcard.get(number).equals("4c") || nameOfcard.get(number).equals("4d")) {
			points = points + 4;
			String value = Integer.toString(points);
			userPoints.setText(value);
		}
		if (nameOfcard.get(number).equals("5a") || nameOfcard.get(number).equals("5b")
				|| nameOfcard.get(number).equals("5c") || nameOfcard.get(number).equals("5d")) {
			points = points + 5;
			String value = Integer.toString(points);
			userPoints.setText(value);
		}

		if (nameOfcard.get(number).equals("6a") || nameOfcard.get(number).equals("6b")
				|| nameOfcard.get(number).equals("6c") || nameOfcard.get(number).equals("6d")) {
			points = points + 6;
			String value = Integer.toString(points);
			userPoints.setText(value);
		}
		if (nameOfcard.get(number).equals("7a") || nameOfcard.get(number).equals("7b")
				|| nameOfcard.get(number).equals("7c") || nameOfcard.get(number).equals("7d")) {
			points = points + 7;
			String value = Integer.toString(points);
			userPoints.setText(value);
		}
		if (nameOfcard.get(number).equals("8a") || nameOfcard.get(number).equals("8b")
				|| nameOfcard.get(number).equals("8c") || nameOfcard.get(number).equals("8d")) {
			points = points + 8;
			String value = Integer.toString(points);
			userPoints.setText(value);
		}
		if (nameOfcard.get(number).equals("9a") || nameOfcard.get(number).equals("9b")
				|| nameOfcard.get(number).equals("9c") || nameOfcard.get(number).equals("9d")) {
			points = points + 9;
			String value = Integer.toString(points);
			userPoints.setText(value);
		}
		if (nameOfcard.get(number).equals("10a") || nameOfcard.get(number).equals("10b")
				|| nameOfcard.get(number).equals("10c") || nameOfcard.get(number).equals("10d")) {
			points = points + 10;
			String value = Integer.toString(points);
			userPoints.setText(value);
		}

		if (nameOfcard.get(number).equals("11a") || nameOfcard.get(number).equals("11b")
				|| nameOfcard.get(number).equals("11c") || nameOfcard.get(number).equals("11d")
				|| nameOfcard.get(number).equals("12a") || nameOfcard.get(number).equals("12b")
				|| nameOfcard.get(number).equals("12c") || nameOfcard.get(number).equals("12d")
				|| nameOfcard.get(number).equals("13a") || nameOfcard.get(number).equals("13b")
				|| nameOfcard.get(number).equals("13c") || nameOfcard.get(number).equals("13d")) {
			points = points + 10;
			String value = Integer.toString(points);
			userPoints.setText(value);
		}
		if (nameOfcard.get(number).equals("15a") || nameOfcard.get(number).equals("15b")
				|| nameOfcard.get(number).equals("15c") || nameOfcard.get(number).equals("15d")) {
			points = points + 2;
			String value = Integer.toString(points);
			userPoints.setText(value);
		}

		if (nameOfcard.get(number).equals("14a") || nameOfcard.get(number).equals("14b")
				|| nameOfcard.get(number).equals("14c") || nameOfcard.get(number).equals("14d")) {
			int input = JOptionPane.showOptionDialog(null,
					"You got an ace. How many points would you like? Press NO for 11 and YES for 1", "Ace ALERT!",
	...
	public void generateCards() { // randomly generating cards for computer and
									// user
		for (int j = 3; j <= 15; j++) {
			for (int i = 1; i <= 4; i++) {
				if (i == 1) {
	...
	public void computerscore(int number) { // scoring for each picture
											// according to their names for the
											// computer
		if (nameOfcard.get(number).equals("3a") || nameOfcard.get(number).equals("3b")
				|| nameOfcard.get(number).equals("3c") || nameOfcard.get(number).equals("3d")) {
